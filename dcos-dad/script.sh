...
cat dcos-dad-slave.json | sed -e "s/dcos_dad_bootstrap_ip/$dcos_dad_bootstrap_ip/;s/dcos_dad_bootstrap_port/$dcos_dad_bootstrap_port/;s/dcos_dad_prefix/$dcos_dad_prefix/" >| genconf/tmp/dcos-dad-slave.json
